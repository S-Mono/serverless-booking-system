 ...
 *   node send-release-notice.js --title "..." --body "..." --version 1.1.0 --dryRun true
 */
...
async function main() {
  ...
  if (!title || !body) {
    ...
    console.error('Usage: node send-release-notice.js --title "..." --body "..." [--releaseUrl /releases] [--version 1.1.0] [--dryRun true]\n')
    process.exit(1)
  }
