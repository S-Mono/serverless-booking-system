...
<template>
    <div class="terms-container">
        ...
        <div class="terms-content">
            <p class="updated-date">最終更新日: 2025年12月3日</p>
            ...
            <section>
                <h2>第1条(適用範囲)</h2>
                <p>
                    本規約は、ヘアーサロン ジョイス(以下「当店」または「当社」といいます)が提供する予約サービス(以下「本サービス」といいます)の利用に関する条件を、本サービスを利用するすべてのお客様(以下「ユーザー」といいます)と当社との間で定めるものです。
                </p>
            </section>
            ...
            <section>
                <h2>第3条(予約とキャンセル)</h2>
                <ol>
                    <li>ユーザーは、本サービスを通じて美容・理容サービスの予約を行うことができます。</li>
                    <li>予約のキャンセルは、予約日時の24時間前まで可能です。無断キャンセルや度重なる直前キャンセルが発生した場合、今後の予約を制限させていただく場合があります。</li>
                    <li>当社は、やむを得ない事情により、予約をキャンセルまたは変更する場合があります。この場合、可能な限り事前にユーザーに通知するよう努めます。</li>
                </ol>
            </section>
            ...
            <section>
                ...
                <ol>
                    ...
                    <li>前項ただし書に定める場合であっても、当社は、当社の過失(重過失を除きます。)による債務不履行または不法行為によりユーザーに生じた損害のうち特別な事情から生じた損害(当社またはユーザーが損害発生につき予見し、または予見し得た場合を含みます。)について一切の責任を負いません。
                    </li>
                </ol>
            </section>
            ...
            <section>
                ...
                <ol>
                    ...
                    <li>本規約の変更後、本サービスの利用を開始した場合には、変更後の規約に同意したものとみなします。</li>
                </ol>
            </section>
